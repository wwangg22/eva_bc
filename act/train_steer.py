...
from act.steer_core import SteerCore
from act.steer_wrapper import SteerRlGamesWrapper
...
def main() -> None:
    ...
    core = SteerCore(controller, mdp, here.parent / "experiments" / "exp06_grasp_bit.pt",
