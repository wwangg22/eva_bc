...
from slot_act.eval_residual import make_fixed_x0
from slot_act.residual_core import RES_ACTION_DIM, ResidualCore
from slot_act.residual_wrapper import ResidualRlGamesWrapper
...
def main() -> None:
    ...
    core = ResidualCore(controller, mdp, alpha=0.1, flush=True)
